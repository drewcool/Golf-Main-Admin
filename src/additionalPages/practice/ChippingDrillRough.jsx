...
import { addUploadChippingDrillRoughAPI, getUploadChippingDrillRoughAPI } from "../../utils/practiceApi";
import { mediaUrl } from "../../utils/URL";

const ChippingDrillRough = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await addUploadChippingDrillRoughAPI(formData);
    ...
    useEffect(() => {
        const fetchDefaultValues = async () => {
            try {
                const data = await getUploadChippingDrillRoughAPI();
                setTitle(data.title || "");
...
export default ChippingDrillRough;
