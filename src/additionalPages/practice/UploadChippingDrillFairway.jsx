...
import { addUploadChippingDrillFairwayAPI, getUploadChippingDrillFairwayAPI } from "../../utils/practiceApi";
import { mediaUrl } from "../../utils/URL";

const UploadChippingDrillFairway = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await addUploadChippingDrillFairwayAPI(formData);
    ...
    useEffect(() => {
        const fetchDefaultValues = async () => {
            try {
                const data = await getUploadChippingDrillFairwayAPI();
                setTitle(data.title || "");
...
export default UploadChippingDrillFairway;
