...
import { addMakeableAPI, getMakeableAPI } from "../../utils/practiceApi";
...
const AddMakeable = () => {
    ...
    useEffect(() => {
        const fetchDefaultValues = async () => {
            try {
                const data = await getMakeableAPI();
                setTitle(data.title || "");
            ...
            <main className="app-content" >
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div style={{ marginBottom: "20px" }}>
                        ...
                        <ReactQuill value={howToDoIt} onChange={setHowToDoIt} />
                    </div>
