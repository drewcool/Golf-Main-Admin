...
import { addUploadApproachVariableAPI, getUploadApproachVariableAPI } from "../../utils/practiceApi";
import { mediaUrl } from "../../utils/URL";

const ApproachVariable = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await addUploadApproachVariableAPI(formData);
    ...
    useEffect(() => {
        const fetchDefaultValues = async () => {
            try {
                const data = await getUploadApproachVariableAPI();
                setTitle(data.title || "");
...
export default ApproachVariable;
