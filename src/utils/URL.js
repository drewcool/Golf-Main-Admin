...
export const mediaUrl = () => `http://13.51.189.31:5000/`;

// export const mediaUrl = () => `http://localhost:7500/`;
...
export const APIURL = () => `http://13.51.189.31:5000/`;
// export const APIURL = () => `http://localhost:7500/`;
